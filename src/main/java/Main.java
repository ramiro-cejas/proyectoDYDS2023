...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //TODO el test se desarrolla en una unica clase para testear la totalidad de la funcionalidad del modelo pero deberia ser en varias clases chiquitas para cada funcionalidad
